...
1. Is this an observational study or an experiment?
  I believe this is an experimental study because they're sending out ficticious resumes and seeing how people respond. 


2. The variable of interest is `received_callback`.
  What type of variable is this? Binary value
  What do the values represent? if they got a callback or not. 
...
ggplot(resume, aes(x = received_callback))+
  geom_bar()+
  labs(title = "Callback Frequencies", x= "Callback Category", y ="Count")
```
...
The percentages are very different. We need to understand what factors are impacting callback rates. 
...
{\displaystyle t={\frac {p}{1-p}}}

.0805 / (1 - .0805) = .088. 1 - .088 
