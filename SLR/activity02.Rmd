...
11. Is there any apparent pattern in the residuals plot?
  ...
  There seems to be a bit of fanning from left to right which may indicate a violation in linearity. 
...
13. Based on the residuals vs. fitted plot, does the constant variability condition appear to be violated?
  Why or why not?
  I'd say no.. Nothing very obvious in terms of a pattern. 
